...
MODULE_AUTHOR("Minea Alexandra + Pauca Dragos-Cristian");
MODULE_LICENSE("GPL");
...
static inline void set_THREI(int base)
{
	u_char mask = 0;
...
static inline void set_RDAI(int base)
{
	u_char mask = 0;
				...
				size_t size, loff_t *offset)
{
	...
	/* block until there is space in kfifo to write */
